...
DOWNLOAD_URL=$(curl -s github.com/h40st3r/AutoBuildImmortalWrt/releases/download/Autobuild-x86-64/immortalwrt-24.10.2-x86-64-generic-squashfs-combined-efi.img.gz | jq -r '.assets[] | select(.name == "'"$FILE_NAME"'") | .browser_download_url')
...
# 原版immortalwrt
# DOWNLOAD_URL="https://github.com/h40st3r/AutoBuildImmortalWrt/releases/download/Autobuild-x86-64/immortalwrt-24.10.2-x86-64-generic-squashfs-combined-efi.img.gz"
# 原版KWRT
